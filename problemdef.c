...
/* 		   std::vector<std::vector<double> > & data, bool & temphit); */

void cost_function(double * obj, double * constr, double *xreal, 
		   std::vector<std::vector<double> > & data, bool & hit, bool & reached, 
		   double & proximity, size_t & lifetime, double & dist_travelled, 
		   double & lc, double & fc, double & rc);

void test_problem (double *xreal, double *xbin, int **gene, double *obj, 
		   double *constr, std::vector<std::vector<double> > & data,
		   bool & hit, bool & reached, double & proximity, 
		   size_t & lifetime, double & dist_travelled,
		   double & lc, double & fc, double & rc) {
  //data.clear();
  std::vector<std::vector<double> > tempdata;
  hit = false;
  cost_function(obj, constr, xreal, tempdata, hit, reached, proximity, 
		lifetime, dist_travelled, lc, fc, rc);
  data = tempdata;
